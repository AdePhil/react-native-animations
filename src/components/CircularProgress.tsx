...
const size = height * 0.65;
const padding = 1;
const radius = size / 2 - padding;
const AnimatedCircle = Animated.createAnimatedComponent(Circle);

export default () => {
  const start = new Value(Math.PI);
  const end = new Value(-Math.PI);
  ...
  return (
    <View style={styles.container}>
      ...
      <Cursor angle={start} {...{ radius }} width={padding * 2} />
      <Cursor angle={end} {...{ radius }} width={padding * 2} />
    </View>
  );
};
